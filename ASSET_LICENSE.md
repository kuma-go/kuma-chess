# KUMA CHESS Asset Notice

Copyright © 2026 koseulki. All Rights Reserved.

The original KUMA CHESS name, logos, animal chess-piece artwork, portraits, user-interface artwork, backgrounds, sound assets, and related source files are proprietary creative works. No permission is granted to copy, redistribute, resell, train models on, modify, or use these original assets in another product without prior written permission from the copyright holder.
