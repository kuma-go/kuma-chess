import {
  ...
  grantCoinsOnce,
  readPlayerState,
} from "./src/playerState.js?v=20260922-profile-road115";
import {
  getDailyMissionSnapshot,
} from "./src/dailyMissions.js?v=20260922-profile-road115";
import { getMedalSummary, recordAmbientMedalEvent } from "./src/medals.js?v=20260922-profile-road115";
import { readProfileState } from "./src/profileState.js?v=20260922-profile-road115";
import { installFeedbackUnlock, playFeedback } from "./src/feedback.js?v=20260922-profile-road115";
import {
  getMenuBgmPlaybackState,
  installMenuBgm,
  setMenuBgmPlaybackWanted,
  setMenuBgmVolume,
} from "./src/menuBgm.js?v=20260922-profile-road115";
import { applyMainPageContentLanguage } from "./main-page-content-i18n.js?v=20260922-profile-road115";
import { normalizeOnlineRoomCode } from "./src/onlineRoom.js?v=20260922-profile-road115";
import { clearOnlineSession, readOnlineSession, saveOnlineSession } from "./src/onlineSession.js?v=20260922-profile-road115";
...
const ASSET_RETRY_VERSION = "20260922-profile-road115";
...
function bindEvents() {
  ...
  const resumeHome = () => {
    ...
    refreshHomeState();
    if (reward.claimed) showHomeRewardLine(currentWebCopy().dailyLoginReward(reward.amount));
  };
  window.addEventListener("focus", resumeHome);
  ...
  window.addEventListener("kuma-medals-changed", refreshHomeState);
  ...
  window.setInterval(resumeHome, 60_000);
}
