...
const TEXT = {
  ko: {
    ...
    "start.pvp": "START", "start.pvpSub": "마주보고 2인 플레이", "start.ranking": "순위",
    ...
    "tug.turn": "{side} 차례 · 기물을 끌어 힘을 모으세요", "tug.wait": "{side} 대기",
  ...
  en: {
    ...
    "start.pvp": "START", "start.pvpSub": "Face-to-face two-player game", "start.ranking": "Ranking",
    ...
    "tug.turn": "{side} turn · Pull a piece to build power", "tug.wait": "{side} waiting",
  ...
  ja: {
    ...
    "start.pvp": "START", "start.pvpSub": "向かい合って2人プレイ", "start.ranking": "ランキング",
    ...
    "tug.turn": "{side}の番 · 駒を引いて力をためましょう", "tug.wait": "{side} 待機",
