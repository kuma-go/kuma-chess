...
import { ROYAL_ROAD_PUZZLE_STAGES } from "../royalRoadPuzzleStages.js?v=20260904-accountredirect106";
import {
  getRoyalRoadPuzzleUnlockCount,
  readRoyalRoadPuzzleProgress,
} from "../royalRoadPuzzleProgress.js?v=20260904-accountredirect106";
import {
  addBackButton,
  addCoinPill,
  addPageTitle,
