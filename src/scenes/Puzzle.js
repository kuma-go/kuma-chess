import { Chess } from "../vendor-chess.js?v=20260902-reward85";
import { alignBoardPieceView, createPieceView, setSelectedOutline } from "../pieceStyles.js?v=20260902-reward85";
import { playFeedback } from "../feedback.js?v=20260902-reward85";
import { puzzleGlossary, puzzleText, t } from "../i18n.js?v=20260902-reward85";
import { getClearedPuzzleIds, getPuzzle, markPuzzleCleared, PUZZLES } from "../puzzles.js?v=20260902-reward85";
import {
  markMedalsSeen,
  recordPuzzleCompletion,
  recordPuzzleHint,
} from "../medals.js?v=20260902-reward85";
import { recordDailyPuzzleCompletion } from "../dailyMissions.js?v=20260902-reward85";
import { getPieceUnlockNotices, COSTS, spendCoins } from "../playerState.js?v=20260902-reward85";
import { SpriteButton } from "../ui/SpriteButton.js?v=20260902-reward85";
import {
  addDarkTopBar,
  addChessBoard,
  addLargeTextButton,
...
import { showMedalAwardSequence } from "../ui/MedalAward.js?v=20260902-reward85";
import { pieceUnlockSequenceDuration, showPieceUnlockNoticeSequence } from "../ui/PieceUnlockLine.js?v=20260902-reward85";
...
export class Puzzle extends Phaser.Scene {
  ...
  createUI() {
    ...
    this.hintCostGroup = addMiniCoin(this, 137, height - 20, COSTS.puzzleHint, 60);
  ...
  completePuzzle() {
    ...
    const dailyResult = recordDailyPuzzleCompletion({
      sessionId: this.puzzleSessionId,
  ...
  showHint() {
    if (this.hintUsed) {
      ...
      this.flashMessage(t("puzzle.hintAgain"), KUMA_COLORS.orange);
      return;
    }

    const purchase = spendCoins(COSTS.puzzleHint);
    if (!purchase.ok) {
      showRewardLine(this, t("puzzle.hintNotEnough", {
        coins: purchase.coins,
        cost: COSTS.puzzleHint,
      }), {
    ...
    this.hintUsed = true;
    this.hintCostGroup?.setAlpha(0.42);
    this.hintText.setText(puzzleText(this.puzzle, "hint"));
    this.flashMessage(t("puzzle.hintNotice", { cost: COSTS.puzzleHint }), KUMA_COLORS.orange);
