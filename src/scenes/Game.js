...
import { pieceTextureKey } from "../pieceAssets.js?v=20260902-online92";
...
import { AI_DIFFICULTIES, getAIDifficulty, grantCoinsOnce, recordGameResult } from "../playerState.js?v=20260902-online92";
import { recordCompletedGame } from "../medals.js?v=20260902-online92";
import { recordDailyGameCompletion } from "../dailyMissions.js?v=20260902-online92";
import { allowScreenSleep, keepScreenAwakeDuringMatch } from "../screenWakeLock.js?v=20260902-online92";
import {
  addDarkTopBar,
  addChessBoard,
  addLargeTextButton,
...
export class Game extends Phaser.Scene {
  ...
  pickChallengeAIMove(aiColor) {
    ...
    return new Promise((resolve) => {
      ...
      try {
        worker = new Worker(
          new URL("../ai/challengeWorker.js?v=20260902-online92", import.meta.url),
