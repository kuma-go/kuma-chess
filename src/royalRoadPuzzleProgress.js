import { grantCoinsOnce } from "./playerState.js?v=20260904-pwarefresh103";
import { readJsonFromStorage, writeJsonToStorage } from "./storage.js?v=20260904-pwarefresh103";
