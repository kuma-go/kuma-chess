import { grantCoinsOnce } from "./playerState.js?v=20260904-mobilefix102";
import { readJsonFromStorage, writeJsonToStorage } from "./storage.js?v=20260904-mobilefix102";
