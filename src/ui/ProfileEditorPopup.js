...
import {
  ...
  readProfileState,
  writeProfileState,
} from "../profileState.js?v=20260922-profile-road115";
import {
  addLargeTextButton,
...
export function showProfileEditorPopup(scene, options = {}) {
  ...
  const nameButton = addOutlinedTextButton(scene, px + 101, panelTop + 259, copy.editName, () => {
    closeNicknameDialog?.();
  ...
  addText(scene, layer, px - 70, panelTop + 307, copy.nameUnique, {
