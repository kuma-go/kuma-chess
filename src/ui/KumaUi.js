import { getPieceUnlockNotices, readPlayerState, redeemHiddenRewardCoupon, writePlayerState } from "../playerState.js?v=20260904-mobilefix102";
import { t } from "../i18n.js?v=20260904-mobilefix102";
import { SpriteButton } from "./SpriteButton.js?v=20260904-mobilefix102";
import { setMenuBgmVolume } from "../menuBgm.js?v=20260904-mobilefix102";
import {
  isVibrationSupported,
  playFeedback,
  primeAudioFromGesture,
  vibrateFeedback,
} from "../feedback.js?v=20260904-mobilefix102";
  ...
  const redraw = () => {
    ...
    const redeemCoupon = () => {
      ...
      if (unlockNotices.length) {
        import("./PieceUnlockLine.js?v=20260904-mobilefix102").then(({ showPieceUnlockNoticeSequence }) => {
