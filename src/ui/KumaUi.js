import { getPieceUnlockNotices, readPlayerState, redeemHiddenRewardCoupon, writePlayerState } from "../playerState.js?v=20260904-accountfix104";
import { t } from "../i18n.js?v=20260904-accountfix104";
import { SpriteButton } from "./SpriteButton.js?v=20260904-accountfix104";
import { setMenuBgmVolume } from "../menuBgm.js?v=20260904-accountfix104";
import {
  isVibrationSupported,
  playFeedback,
  primeAudioFromGesture,
  vibrateFeedback,
} from "../feedback.js?v=20260904-accountfix104";
  ...
  const redraw = () => {
    ...
    const redeemCoupon = () => {
      ...
      if (unlockNotices.length) {
        import("./PieceUnlockLine.js?v=20260904-accountfix104").then(({ showPieceUnlockNoticeSequence }) => {
