import { getPieceUnlockNotices, readPlayerState, redeemHiddenRewardCoupon, writePlayerState } from "../playerState.js?v=20260903-gameplay99";
import { t } from "../i18n.js?v=20260903-gameplay99";
import { SpriteButton } from "./SpriteButton.js?v=20260903-gameplay99";
import { setMenuBgmVolume } from "../menuBgm.js?v=20260903-gameplay99";
import {
  isVibrationSupported,
  playFeedback,
  primeAudioFromGesture,
  vibrateFeedback,
} from "../feedback.js?v=20260903-gameplay99";
  ...
  const redraw = () => {
    ...
    const redeemCoupon = () => {
      ...
      if (unlockNotices.length) {
        import("./PieceUnlockLine.js?v=20260903-gameplay99").then(({ showPieceUnlockNoticeSequence }) => {
