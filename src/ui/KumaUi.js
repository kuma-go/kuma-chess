import { getPieceUnlockNotices, readPlayerState, redeemHiddenRewardCoupon, writePlayerState } from "../playerState.js?v=20260902-frame86";
import { t } from "../i18n.js?v=20260902-frame86";
import { SpriteButton } from "./SpriteButton.js?v=20260902-frame86";
import { setMenuBgmVolume } from "../menuBgm.js?v=20260902-frame86";
import {
  isVibrationSupported,
  playFeedback,
  primeAudioFromGesture,
  vibrateFeedback,
} from "../feedback.js?v=20260902-frame86";
  ...
  const redraw = () => {
    ...
    const redeemCoupon = () => {
      ...
      if (unlockNotices.length) {
        import("./PieceUnlockLine.js?v=20260902-frame86").then(({ showPieceUnlockNoticeSequence }) => {
